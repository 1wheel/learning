...
In addition to creating SVGs from scratch in Illustrator and animating them with D3, we've also used D3 to transform data to an SVG, then saved the SVG and opened it with Illustrator to clean up positioning. This technique is particularly useful for tidying force layouts. 
...
Don't be afraid to experiment with creating your own tools to improve your workflow - shrinking the feedback loop pays off in unexpected ways.
